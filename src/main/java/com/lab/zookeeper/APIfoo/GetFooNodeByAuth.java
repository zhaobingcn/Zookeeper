...
public class GetFooNodeByAuth implements Watcher {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try{
            ZooKeeper noAuthZK = new ZooKeeper("10.108.219.44:2181", 50000, new GetFooNodeByAuth());
        ...
        try {
            ZooKeeper wrongAuthZK = new ZooKeeper("10.108.219.44:2181", 50000, new GetFooNodeByAuth());
        ...
        ZooKeeper rightAuthZK = new ZooKeeper("10.108.219.44:2181", 50000, new GetFooNodeByAuth());
